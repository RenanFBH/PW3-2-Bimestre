...
?>
            <div class="container">
				<div class="card rounded-4 margin-2">
					<h2 class="text-center">Editar Usuário <?php echo $usuario["id"]; ?></h2>
					<hr>
					<form action="edit.php?id=<?php echo $usuario['id']; ?>" method="post" enctype="multipart/form-data" class="row">
						<div class="col-lg-6">
							<div class="box">
								<div class="input-box input-box-2" id="uploadArea">
									...
									<div class="upload-wrapper" style="position:relative; width:100%; max-width:100%; height:90%;">
										...
										<img id="imgPreview" src="fotos/<?php echo $usuario['foto']; ?>" style="display: block; width: 100%; margin-top: 10px;" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-lg-12 align-items-center">
								<div class="wrapper me-5 ms-5">
									<div class="input-data" style="margin-top:10%; !important">
										<input type="text" name="usuario[nome]" maxlength="30" value="<?php echo $usuario["nome"]; ?>" required>
										<div class="underline"></div>
										<label>Nome / Razão Social</label>
									</div>
									<div class="input-data" style="margin-top:10%; !important">
										<input  type="text" name="usuario[user]" maxlength="20" value="<?php echo $usuario["user"]; ?>" required>
										<div class="underline"></div>
										<label>Login</label>
									</div>
									<div class="input-data d-flex position-relative" style="margin-top:10%;">
										<input type="password" name="usuario[password]" id="passwordInput" minlength="5" maxlength="20" style="padding-right: 40px;">
										<div class="underline"></div>
										<label>Senha</label>
									</div>
								</div>
